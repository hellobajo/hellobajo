  ...
  const carouselSlides = [
    {
      ...
      tag: lang === 'EN' ? 'PRIVATE CITY TOUR' : lang === 'ZH' ? '私人包车 / 城市游' : 'PRIVATE CITY TOUR',
      title: lang === 'EN' ? 'Private City Tour: Comfort, Your Way' : lang === 'ZH' ? '私人包车：舒适随心，专业出行' : 'Private City Tour: Nyaman & Privat',
    ...
    },
    {
      ...
      tag: lang === 'EN' ? 'ISLAND HOPPING & BOATS' : lang === 'ZH' ? '跳岛游与船只' : 'ISLAND HOPPING & BOATS',
      title: lang === 'EN' ? 'Komodo Island Hopping & Boats' : lang === 'ZH' ? '科莫多岛跳岛与快艇包船' : 'Komodo Island Hopping & Boats',
